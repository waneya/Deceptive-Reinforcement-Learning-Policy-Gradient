...
START = (46, 80)                    # coordinates of start location in (col,row) format
GOAL = (79, 11)                     # coordinates of goal location in (col,row) format
POSS_GOALS = [(12, 52), (11, 75), (47, 12), (68, 64)]
