...
MAP_FILE = "drl/49_high.map"  	# map filename - must be in maps (sister dir to src)
START = (18, 24)                # coordinates of start location in (col,row) format
GOAL = (46, 21)                 # coordinates of goal location in (col,row) format
POSS_GOALS = [(28, 43), (39, 11), (27, 39), (34, 13)]
