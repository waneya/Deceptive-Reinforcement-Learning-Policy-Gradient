...
MAP_FILE = "drl/100_maze.map"   # map filename - must be in maps (sister dir to src)
START = (89, 54)                # coordinates of start location in (col,row) format
GOAL = (18, 47)                 # coordinates of goal location in (col,row) format
POSS_GOALS = [(12, 12), (67, 89), (54, 47), (81, 13)]
