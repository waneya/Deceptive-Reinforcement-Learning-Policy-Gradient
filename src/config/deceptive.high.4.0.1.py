...
MAP_FILE = "drl/49_high.map"    # map filename - must be in maps (sister dir to src)START = (36, 9)
START = (26, 37)                # coordinates of start location in (col,row) format
GOAL = (5, 10)                  # coordinates of goal location in (col,row) format
POSS_GOALS = [(5, 27), (42, 31)]
