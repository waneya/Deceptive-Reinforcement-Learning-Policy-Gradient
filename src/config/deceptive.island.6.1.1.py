...
START = (11, 75)                    # coordinates of start location in (col,row) format
GOAL = (47, 12)                     # coordinates of goal location in (col,row) format
POSS_GOALS = [(79, 11), (46, 80), (68, 64), (12, 52)]
